...
buttons = [
    [
        InlineKeyboardButton(text="Cᴏᴍᴍᴀɴᴅs🧑‍💻", url="https://t.me/Angelx_robot?start=help"),
    ...
    [  
        InlineKeyboardButton(text="Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ💞!!", url="https://t.me/Angelx_robot?startgroup=true"),
    ],
]

SMTG_OR_WOT = [
    [
      InlineKeyboardButton(text="ᴊᴏɪɴ ᴍʏ ʜᴇᴀᴠᴇɴ🧚‍♀️", url='https://t.me/Missangelsupport'),
    ],
    [
      InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇs", url='t.me/Missangelsupport'),
      InlineKeyboardButton(text="ᴄᴏᴏʟ-ᴋɪᴅᴅᴏ", url='tg://user?id=5231150389'),
    ],
]
...
╰─⊸➢ᴊᴏɪɴ ꜱᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ ᴀɴᴅ ʀᴇᴘᴏʀᴛ ᴛʜᴇ ᴇʀʀᴏʀꜱ @Missangelsupport ™**[🎀](https://telegra.ph/file/41ce5fe42973b7ffe1511.mp4)

➬➬ Pᴏᴡᴇʀᴇᴅ Bʏ Cᴏɴᴛʀᴏʟʟᴇʀ [ᴀɴɢᴇʟ💞](t.me/Missangelsupport) ✨
"""

DONATE_STRING = """IF U WANT TO DONATE THEN JUST JOIN @Missangelsupport\nOr U can donate By just Clicking [Here](https://t.me/crazy_1299),"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker("CAACAgUAAxkBAAIDXmSUHr0IiMU0IZA1vEtaB8FCv1LaAAK1BAACU4k5VDGuWHD0S3zXLwQ")
        ...
        update.effective_message.reply_sticker("CAACAgUAAxkBAAIDXmSUHr0IiMU0IZA1vEtaB8FCv1LaAAK1BAACU4k5VDGuWHD0S3zXLwQ", parse_mode=ParseMode.HTML, reply_markup=InlineKeyboardMarkup(SMTG_OR_WOT))
        '''update.effective_message.reply_video(
            ANGEL_LOGO, caption= "☆Mɪss <a href='https://t.me/Angelx_robot'>Aɴɢᴇʟ♡︎</a> ᴀᴡᴀᴋᴇ ᴀʟʀᴇᴀᴅʏ!\n<b>☆ʜᴀᴠᴇɴ'ᴛ sʟᴇᴘᴛ sɪɴᴄᴇ:</b> <code>{}</code>\n\nᴊᴏɪɴ >>@Missangelsupport".format(
                uptime
            ),
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton(text="ᴊᴏɪɴ ᴍʏ ʜᴇᴀᴠᴇɴ ᴀɴᴅ ʙᴇ ᴀ ᴀɴɢᴇʟ 🧚‍♀️", url="https://t.me/Missangelsupport")]]
            ),
        )'''
        ...
        if mod_match:
            ...
            query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [                       
                        [
                            InlineKeyboardButton(text="♡︎Hᴇᴠᴇɴ♡︎", url="t.me/Missangelsupport"),
...
def luna_about_callback(update, context):
    ...
    if query.data == "luna_":
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text="♻️ᴏꜰꜰɪᴄɪᴀʟ ᴜᴘᴅᴀᴛᴇꜱ🤍", url="https://t.me/Missangelsupport"),
                    ],
                    [
        ...
        query.message.edit_text(
            text=f"ᴜᴍᴍ ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ sᴇᴇ ᴍʏ ꜰᴀᴛʜᴇʀ  !! ʟᴏʟ. \n\nʜᴇʀᴇ ɪs ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀs ᴡʜᴏ ᴄʀᴇᴀᴛᴇᴅ ᴍᴇ \n\nꜰᴏʀ ᴍᴏʀᴇ ʜᴇʟᴘ ᴛᴀᴘ ᴏɴ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ʙᴇʟʟᴏ ʜᴇʀᴇ .!!",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    InlineKeyboardButton(text="🇮🇳-sᴀᴜʀʏᴀ", callback_data="luna_asi"),
                    InlineKeyboardButton(text="🇮🇳-ᴄʀᴀᴢʏ ʙᴏʏ✰", callback_data="luna_asu"),
                ],
                [
        ...
        query.message.edit_text(
            text=f"⏤͟͟͞͞• 𝗖𝗥𝗔𝗭𝗬 ♡︎ 𝗕𝗢𝗬 ✞︎✞︎ ⏤͟͞➤⃟🔥"
                     f"𝙰𝚋𝚘𝚞𝚝 𝙼𝚢 𝙳𝚎𝚟♡︎"
                     f"𝙽𝚊𝚖𝚎:- 𝚌𝚛𝚊𝚣𝚢 𝚋𝚘𝚢✩"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="𝙷𝚎𝚟𝚎𝚗♡︎", url="t.me/Missangelsupport"),
                    InlineKeyboardButton(text="𝙶𝚒𝚝𝙷𝚞𝚋✰", url="https://github.com/iamproaf"),
                 ],
                 [
        ...
        query.message.edit_text(
            text=f"⏤͟͟͞͞• 𝗖𝗥𝗔𝗭𝗬 ♡︎ 𝗕𝗢𝗬 ✞︎✞︎ ⏤͟͞➤⃟🔥✪ 」"
                     ...
                     f"𝙽𝚊𝚖𝚎:- ⏤͟͟͞͞• 𝗖𝗥𝗔𝗭𝗬 ♡︎ 𝗕𝗢𝗬 ✞︎✞︎ ⏤͟͞➤⃟🔥✩"
        ...
        query.message.edit_text(
            text=f"[Angel 💝](https://t.me/Angelx_robot) , is a powerful bot for managing groups with additional features.\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                     InlineKeyboardButton(text="🥂ꜱᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ🥂", url="https://t.me/Missangelsupport"),
                     InlineKeyboardButton(text="ᴀɴɢᴇʟ ᴜᴘᴅᴀᴛᴇꜱ🧚‍♀️", url=f"https://t.me/Missangelsupport"),
                  ],
                  [
                     InlineKeyboardButton(text="📯ɢʙᴀɴ ʟᴏɢꜱ🧨", url="https://t.me/Missangelsupport"),
                     InlineKeyboardButton(text="ᴍᴀɪɴ ʜᴜʙ❗️", url="https://t.me/Missangelsupport"),
                  ],
                  [ 
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi.. ɪ'ᴀᴍ ᴀɴɢᴇʟ*
                 \nHere is the [sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ](https://t.me/Missangelsupport) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
